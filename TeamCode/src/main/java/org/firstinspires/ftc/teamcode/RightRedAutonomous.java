...
@Autonomous(name="Right Red Autonomous", group="K9bot")
public class RightRedAutonomous extends AutonomousBase {

    public RightRedAutonomous() {
        super(true);
    }
    ...
    public void runOpModeImpl() {
        ...
        helper.diaganolDrive(FAST_SPEED, 60, 'r');
    }
}